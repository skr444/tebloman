...
| 1.2.0
| skr444
| Updated screen shots to show new UI.
...
The fragments can only be created, modified or deleted when the *All Fragments* view is selected.
Switch between fragment views using the radio buttons *All Fragments* and *In current profile*.
...
Select the *In current profile* view and click the *Add to profile* button to associate it with the currently selected profile.
